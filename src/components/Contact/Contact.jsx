// Importa o React para poder usar a sintaxe JSX e criar componentes
import React from "react";

// Importa os ícones necessários para os links de contato (LinkedIn, GitHub, email, localização e download de arquivo)
...
// Importa o arquivo de currículo para download
import cv from "../../assets/file/Dev-AndressaCSilva.pdf";

// Define o componente Contact, que renderiza a seção de contato da página
function Contact() {
  return (
