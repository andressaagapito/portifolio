...
function Portifolio() {
  return (
    <div className="container mx-auto relative">
      ...
      {/* Grid de Cards */}
      <div className="flex flex-wrap justify-center items-center bg-[#efe3d4] w-full h-[80vh] p-4">
...
function Card({ text, color, image, captionColor, icon, link }) {
  return (
    <a
      ...
      <div
        className={`relative flex items-center justify-center w-40 h-40 ${color} shadow-lg transform transition-transform duration-300 hover:scale-110 cursor-pointer`}>
      ...
      <div
        className={`mt-3 ${captionColor} w-full text-center flex items-center justify-center gap-2`}>
        {/* Texto */}
        <p className="text-white font-bold py-1">{text}</p>
        {/* Ícones */}
        {icon && (
